...
<head>
    ...
    <style>
        ...
        .ad-container { margin: 20px auto; min-height: 100px; display: flex; justify-content: center; align-items: center; overflow: hidden; }
...
<body>
    <div class="card">
        ...
        <form action="/process" method="post" enctype="multipart/form-data">
            ...
            <div id="humanizer-panel" class="tool-panel active">
                ...
                <div class="ad-container"><script src="https://adm.shinobi.jp/s/475f193df1f880db04b8d1f6299d0192"></script></div>
    ...
    <div class="content-section">
        ...
        <div id="compressor-info" class="info-panel"><h2>Compressor の効果</h2><p>超過分を「比率」で減衰させ、演奏のニュアンスを保ったままピークを抑制します。</p></div>
    ...
    <div class="policy-section">
        <h2>プライバシーポリシー</h2>
        <p><strong>データ処理：</strong>MIDIファイルはサーバーに保存されず、メモリ内で即座に処理されます。</p>
