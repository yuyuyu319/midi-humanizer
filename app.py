...
# ⚠️ これがRenderが探している「app」という名前の本体です。絶対に消さないでください。
app = Flask(__name__)
...
<body>
    <div class="card">
        ...
        <p class="subtitle">打ち込みに、音楽的な「揺らぎ」を付加します。</p>
    ...
    <div class="policy-section">
        <h2>プライバシーポリシー</h2>
        <p><strong>データ処理：</strong>アップロードされたMIDIファイルはサーバーに保存されず、メモリ内で即座に処理・返送されます。</p>
        <p><strong>広告：</strong>当サイトではGoogle AdSense等の広告配信事業者がCookieを利用して広告を配信する場合があります。</p>
    </div>
    <div class="footer-copy">&copy; 2026 MIDI Humanizer Pro</div>
</body>
</html>
"""
