...
<head>
    ...
    <style>
        ...
        .tips { background: #0f172a; padding: 25px; border-radius: 12px; border-left: 5px solid #00e676; margin: 20px 0; }
        ...
        .policy-section h2 { color: #f8fafc; font-size: 1.1rem; border-left: 4px solid #00e676; padding-left: 10px; margin-bottom: 15px; }
